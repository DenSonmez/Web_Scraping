package WebScraping.WebScrapingAndAnalysis.Config;
...
public class HibernateConfig {
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        // adds specified classes from addAnnotatedClasses/annotatedClasses
        for (int i = 0; i < annotatedClasses.length; i++){
            configuration.addAnnotatedClass(annotatedClasses[i]);
        }

        // add annotated classes. Use this or addAnnotatedClasses

    }
    public static void addAnnotatedClasses(Class... classes){
