package SeleniumTask.JunitFrameWork.BeforeAfter;
...
public class Del5TestFlereAfGangMedBefordClassAfterClass {
    ...
    @Test
    @Ignore// den bruger man hvis man hoppe over en test
    public void test02() {
        // title yazdiralim
